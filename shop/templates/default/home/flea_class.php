					  ...
					  <div>
						<p class="pic1">
						  ...
						  <a href="index.php?act=flea_class&seller_input=<?php echo $val['member_id'];?>">
								<img width="20" height="20" onload="javascript:DrawImage(this,20,20);" src="<?php echo UPLOAD_SITE_URL;?>/<?php echo $val['member_avatar']?ATTACH_AVATAR.'/'.$val['member_avatar']:TEMPLATES_PATH.'/images/default_user_portrait.gif';?>" />
							</a>              
						  </span>
						</p>

...
<div id="navBar" class="mb10">
  <ul>
    <li class="fn-left none" <?php echo $output['index_sign'] == 'index' && $output['index_sign'] != '0'?'class="current"':'class="link"'; ?> ><a href="<?php echo SHOP_SITE_URL;?>"><span><?php echo $lang['nc_index'];?></span><span class="line"></span></a></li>
    <?php if($GLOBALS['setting_config']['flea_isuse']=='1'){;?>
    <li class="fn-left link" <?php echo $output['index_sign'] == 'flea' && $output['index_sign'] != '0'?'class="current"':'class="link"'; ?> ><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=flea"><span>二手市场</span><span class="line"></span></a></li>
    <?php }?>     
    ...
    <li class="fn-left" <?php echo $output['index_sign'] == 'coupon' && $output['index_sign'] != '0'?'class="current"':'class="link"'; ?> ><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=coupon"><span><?php echo $lang['nc_coupon'];?></span><span class="line"></span></a></li>

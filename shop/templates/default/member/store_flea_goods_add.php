...
.ncu-form-style dl dt { color: #404040; line-height: 32px; text-align: right; width: 130px; float: left; padding: 6px 6px 0 0; margin: 0;}
...
.ncu-form-style .info-album a { font-weight: bold; color: #999; line-height: 20px; background: url(<?php echo SHOP_TEMPLATES_URL;?>/images/member/album_bg.gif) no-repeat 5px -492px; display: inline-block; height: 20px; padding: 0px 4px 0px 28px; margin: 8px 0px; border: 1px solid #E7E7E7; }	
...
a:hover.ncu-btn3 { color: #FFF; background-position: 0 -30px;  box-shadow: none;}

.ncu-table-style { line-height:20px; width: 100%; border-collapse: collapse; clear: both;}
.ncu-table-style thead th { padding: 5px 0 6px 0; border-bottom: solid 1px #E7E7E7; }

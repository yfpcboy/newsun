...
/**
 *
 * NEWSUN system instller
 *
 *
 */
 error_reporting (0);
 
define('InNEWSUN',true);
...
$html_title = '最新版 NEWSUN官方安装程序';

$html_header = <<<EOF
<div class="header">
  <div class="layout">
    <div class="title">
      <h5>最新版NEWSUN官方安装程序</h5>
      <h2>系统安装向导</h2>
    </div>
    <div class="version">版本: 2015.02.28.1410</div>
  </div>
</div>
...
$html_footer = <<<EOF
<div class="footer"><h5>Powered by <font class="blue">Shop</font><font class="orange">NC</font><font class="black">【B2B2C】</font><sup> </sup></h5>
  <h6>版权所有 2007-2014 &copy; <a href="http://www.xg0750.com" target="_blank">江门市新光电讯发展有限公司</a></h6>
  <h6>软件注册登记编号：软著登字第0654031488号</h6>
</div>
EOF;

      ...
      <tbody>
        ...
        <td class="align-center w200">
	     ...
	     <?php if($v['store_id'] != DEFAULT_PLATFORM_STORE_ID) {?>
               <a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['nc_ensure_del']?>')){location.href='index.php?act=store&op=store_del&store_id=<?php echo $v['store_id']; ?>'}"><?php echo $lang['nc_del']?></a>
                <?php } ?>
            </td>
        </tr>
        <?php } ?>

...
$arr = array(
		...
		'left' =>array(
			...
			9 => array(
				...
				'text' => '短信平台',
				'list' => array(
			        array('args'=>'index,ihuyi,ihuyi',			'text'=>'概述'),
					array('args'=>'userSet,ihuyi,ihuyi',			'text'=>'账号设置'),
					
					array('args'=>'ihuyi_sms,ihuyi,ihuyi',			'text'=>'发送记录'),
					array('args'=>'email,message,setting',			'text'=>'短信设置'),
				)
			),			
		),
);
if(C('flea_isuse')==1){
	...
	$arr['left'][] = array(
				...
				'list' => array(
					...
					3 => array('args'=>'flea,flea,flea',						'text'=>二手管理),
